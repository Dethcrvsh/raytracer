...
namespace Shaders {
    std::string const frag_tex {std::string(R"(#version 330 core
...
void main() {
    ...
    std::string const frag_trace {std::string(R"(#version 330 core
...
void main() {
    ...
    std::string const vert_pass {std::string(R"(#version 330 core
